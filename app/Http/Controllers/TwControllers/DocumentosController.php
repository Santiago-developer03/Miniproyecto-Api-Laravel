...
class DocumentosController extends Controller
{
    ...
    {
        $documentos = tw_documentos::all();

        return response([ 'empresas' => 
        DocumentosResource::collection($documentos), 
    ...
    public function store(Request $request)
    {
       $validate = $request->all();
        ...
        $data = tw_documentos::create($request->all());

        return response(['data' => new DocumentosResource($data), 
     ...
     *
     * @param  \App\tw_documentos  $tw_corporativos
     * @return \Illuminate\Http\Response
     */
    public function show(Request $request)
    {
        try {
            $exception = tw_documentos::findOrFail($request->documento);
        } catch (ModelNotFoundException $exception) {
            return response(['message' => 'Datos no encontrado'], 404);
        }
        
        return response(['documentos' => new DocumentosResource($exception), 
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, tw_documentos $documentos)
    {
        $validate = $request->all();
        ...
        return response(['documentos' => new DocumentosResource($documentos), 
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(tw_documentos $documentos)
    {
        $documentos->delete();
